    ...
    datasets: {
      megaface: {
        ...
        images: [
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("9432741384_71097c4068")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 9432741384,
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("9432532574_011f002ee6")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 9432532574,
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("9429824331_f18045ff8e")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 9429824331,
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("5431706769_823306648f")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 5431706769,
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("5432271046_1e485d7b8b")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 5432271046,
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("5432404966_dde385f6e0")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 5432404966,
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("5431693087_15fe145248")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 5431693087,
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("5431693889_4e69c9424f")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 5431693889,
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("9432753664_14120269f9")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 9432753664,
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("5431715775_faef2ae9a8")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 5431715775,
          ...
          {
            image_url: imagesInThisFolder.find((path) =>
              path.includes("5080789669_1e66d12d3b")
            )!,
            path_alias: "etherworks",
            nsid: "94433649@N00",
            photo_id: 5080789669,
